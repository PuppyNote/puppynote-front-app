...
export default function PasswordResetScreen({ navigation }: any) {
  ...
  const handleSendVerification = async () => {
    ...
    try {
      const code = await authService.sendPasswordResetVerification(email);
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      setIsLoading(false);
      showSimpleAlert('오류', error.message || '비밀번호 재설정에 실패했습니다.');
    }
  };
    ...
    <Layout edges={['top', 'bottom', 'left', 'right']} style={styles.container}>
      ...
      >
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.subtitleText}>가입하신 이메일로 인증번호를 발송합니다</Text>
        </View>
        ...
        <View style={styles.formContainer}>
          ...
          >
            {isLoading && !isCooldown && showVerification ? (
              ...
              <Text style={styles.registerButtonText}>비밀번호 변경하기</Text>
            )}
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.loginContainer}>
          <TouchableOpacity onPress={() => navigation.goBack()}>
            <Text style={styles.loginLink}>로그인 화면으로 돌아가기</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
